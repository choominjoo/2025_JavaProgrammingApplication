...
public class GraphicsDrawLineMouseEx extends JFrame {
    ...
    public GraphicsDrawLineMouseEx() {
        setTitle("draw Lines by Mouse 예제");
    ...
    //선을 그릴 수 있는 패널을 구현한다.
    //이 패널에 Mouse 리스터를 구현한다.
    class MyPanel extends JPanel {
        //그려진 선을 모두 저장하기 위해 시작점은 vStart에
        //끝점은 vEnd 벡터에 각각 저장한다.
        private Vector<Point> vStart = new Vector<Point>(); //시작점
        private Vector<Point> vEnd = new Vector<Point>(); //끝점
